...
import viaversion.viaversion.api.protocol.VersionRange;
...
public class ProtocolVersion {
   ...
   public static ProtocolVersion register(int var0, int var1, String var2, @Nullable VersionRange var3) {
      ...
      versions.put(var4.getVersion(), var4);
      if(var4.isSnapshot()) {
         versions.put(var4.getFullSnapshotVersion(), var4);
      }

      return var4;
   }

   public static boolean isRegistered(int var0) {
      return versions.containsKey(var0);
   }

   @NotNull
   public static ProtocolVersion getProtocol(int var0) {
      Protocol.h();
      ProtocolVersion var2 = (ProtocolVersion)versions.get(var0);
   ...
   public static ProtocolVersion getClosest(String var0) {
      Protocol.h();
      ObjectIterator var2 = versions.values().iterator();
      if(var2.hasNext()) {
