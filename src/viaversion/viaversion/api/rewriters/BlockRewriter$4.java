...
class BlockRewriter$4 extends acE {
   final BlockRewriter this$0;

   BlockRewriter$4(BlockRewriter var1) {
      this.this$0 = var1;
   }
   ...
   private void lambda$registerMap$0(PacketWrapper var1) throws Exception {
      MetadataRewriter.e();
      BlockChangeRecord[] var3 = (BlockChangeRecord[])var1.passthrough(Type.VAR_LONG_BLOCK_CHANGE_RECORD_ARRAY);
