package viaversion.viaversion.protocols.protocol1_12to1_11_1.data;
...
public class AchievementTranslationMapping {
   private static final Object2ObjectOpenHashMap ACHIEVEMENTS = new Object2ObjectOpenHashMap(150, 1.0F);
   private static final Set SPECIAL_ACHIEVEMENTS = new HashSet(10);
   private static boolean c;

   private static void add(String var0, String var1) {
      ACHIEVEMENTS.put(var0, var1);
   }
   ...
   public static String get(String var0) {
      return (String)ACHIEVEMENTS.get(var0);
   }
