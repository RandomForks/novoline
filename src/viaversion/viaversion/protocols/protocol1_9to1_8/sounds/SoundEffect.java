...
import net.acE;
import viaversion.viaversion.protocols.protocol1_9to1_8.sounds.SoundCategory;
...
public enum SoundEffect {
   ...
   private SoundEffect(String var3, String var4, SoundCategory var5) {
      this.category = var5;
      this.newName = var4;
      this.name = var3;
      this.breaksound = var3.startsWith("dig.");
   }

   private SoundEffect(String var3, String var4, SoundCategory var5, boolean var6) {
      this.category = var5;
      this.newName = var4;
      this.name = var3;
      if(!var3.startsWith("dig.")) {
         ;
      }
   ...
   public static SoundEffect getByName(String var0) {
      c();
      var0 = var0.toLowerCase(Locale.ROOT);
      return (SoundEffect)effects.get(var0);
   }
   ...
   static {
      ...
      for(SoundEffect var10 : values()) {
         effects.put(var10.getName(), var10);
      }
