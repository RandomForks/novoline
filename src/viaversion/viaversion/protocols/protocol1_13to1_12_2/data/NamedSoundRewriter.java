...
public class NamedSoundRewriter {
   public static final Map oldToNew = new HashMap();

   public static String getNewId(String var0) {
      amt.c();
      String var2 = (String)oldToNew.get(var0);
      return var2 != null?var2:var0.toLowerCase(Locale.ROOT);
   }
