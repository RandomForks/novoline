...
import viaversion.viaversion.protocols.protocol1_13to1_12_2.data.ParticleRewriter$1;
import viaversion.viaversion.protocols.protocol1_13to1_12_2.data.ParticleRewriter$3;
import viaversion.viaversion.protocols.protocol1_13to1_12_2.data.ParticleRewriter$NewParticle;
...
public class ParticleRewriter {
   ...
   public static Gh a(int var0, Integer[] var1) {
      ...
      if(var0 >= particles.size()) {
         Via.getPlatform().getLogger().severe("Failed to transform particles with id " + var0 + " and data " + Arrays.toString(var1));
         return null;
      } else {
