...
public class WrappedBlockData {
   ...
   public static WrappedBlockData fromString(String var0) {
      ...
      String var3 = var2[0];
      WrappedBlockData var4 = new WrappedBlockData(var3, ConnectionData.getId(var0));
      if(var2.length > 1) {
         String var5 = var2[1];
         var5 = var5.replace("]", "");
   ...
   public static WrappedBlockData fromStateId(int var0) {
      abi.b();
      String var2 = ConnectionData.getKey(var0);
      if(var2 != null) {
         return fromString(var2);
      } else {
         Via.getPlatform().getLogger().info("Unable to get blockdata from " + var0);
