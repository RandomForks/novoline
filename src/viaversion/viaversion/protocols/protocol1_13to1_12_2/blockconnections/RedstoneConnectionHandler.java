...
public class RedstoneConnectionHandler extends abi {
   ...
   public int connect(UserConnection var1, Position var2, int var3) {
      short var4 = 0;
      var4 = (short)(var4 | this.connects(var1, var2, BlockFace.EAST));
      var4 = (short)(var4 | this.connects(var1, var2, BlockFace.NORTH) << 2);
      var4 = (short)(var4 | this.connects(var1, var2, BlockFace.SOUTH) << 4);
      var4 = (short)(var4 | this.connects(var1, var2, BlockFace.WEST) << 6);
      var4 = (short)(var4 | powerMappings.get(var3) << 8);
      return connectedBlockStates.getOrDefault(var4, var3);
   }

   private int connects(UserConnection var1, Position var2, BlockFace var3) {
      abi.b();
      ...
      if(this.connects(var3, var6)) {
         ...
         int var7 = this.getBlockData(var1, var5.getRelative(BlockFace.TOP));
         if(redstone.contains(Integer.valueOf(var7)) && !ConnectionData.occludingStates.contains(this.getBlockData(var1, var2.getRelative(BlockFace.TOP)))) {
            return 2;
         } else {
            int var8 = this.getBlockData(var1, var5.getRelative(BlockFace.BOTTOM));
            return redstone.contains(Integer.valueOf(var8)) && !ConnectionData.occludingStates.contains(this.getBlockData(var1, var5))?1:0;
         }
      }
   }
   ...
   private boolean connects(BlockFace var1, int var2) {
      abi.b();
      BlockData var4 = (BlockData)ConnectionData.blockConnectionData.get(var2);
   ...
   private static void lambda$init$0(RedstoneConnectionHandler var0, WrappedBlockData var1) {
      ...
      if("minecraft:redstone_wire".equals(var1.getMinecraftKey())) {
         ...
         connectedBlockStates.put(getStates(var1), var1.getSavedBlockStateId());
         powerMappings.put(var1.getSavedBlockStateId(), Integer.parseInt(var1.getValue("power")));
      }
   }
}
