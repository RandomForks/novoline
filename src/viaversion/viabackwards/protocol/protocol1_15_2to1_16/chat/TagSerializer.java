...
public class TagSerializer {
   ...
   public static JsonObject toJson(CompoundTag var0) {
      kF.b();
      JsonObject var2 = new JsonObject();
      Iterator var3 = var0.getValue().entrySet().iterator();
      if(var3.hasNext()) {
         Entry var4 = (Entry)var3.next();
         var2.add((String)var4.getKey(), toJson((Tag)var4.getValue()));
      }
   ...
   private static JsonElement toJson(Tag var0) {
      int[] var1 = kF.b();
      if(var0 instanceof CompoundTag) {
         return toJson((CompoundTag)var0);
