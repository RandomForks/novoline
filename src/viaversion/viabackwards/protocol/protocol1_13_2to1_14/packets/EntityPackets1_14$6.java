...
class EntityPackets1_14$6 extends acE {
   final EntityPackets1_14 this$0;

   EntityPackets1_14$6(EntityPackets1_14 var1) {
      this.this$0 = var1;
   }
   ...
   private void lambda$registerMap$0(PacketWrapper var1) throws Exception {
      this.this$0.addTrackedEntity(var1, ((Integer)var1.get(Type.VAR_INT, 0)).intValue(), N0.EXPERIENCE_ORB);
   }
}
