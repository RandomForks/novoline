...
@Metadata(
   ...
   d2 = {"Lnet/skidunion/aw;", "Lnet/skidunion/ao;", "()V", "a", "", "client", "Lnet/skidunion/o;", "args", "Lcom/google/gson/JsonObject;"}
)
public final class aw extends ao {
   ...
   public void a(@NotNull o var1, @NotNull JsonObject var2) {
      ...
      this.a().info("Logged in as " + var4.c());
      var1.a().a(var4.c());
      var1.a(I.AUTHENTICATED);
      var1.n().countDown();
      var1.c().a((q)(new B()));
      if(acE.b() == null) {
         a("QaIH2");
   ...
   private aw() {
      super(2, (L)null, 2, (DefaultConstructorMarker)null);
   }
