...
public class FG extends CommandBase {
   ...
   public void processCommand(ICommandSender var1, String[] var2) throws CommandException {
      if(var2.length < 6) {
         ...
         if(var14.isEmpty()) {
            ...
            this.a(var1, var14, new CommandSpreadPlayers$Position(var5, var7), var9, var11, ((Entity)var14.get(0)).worldObj, var13);
         }
      }
   }

   private void a(ICommandSender var1, List var2, CommandSpreadPlayers$Position var3, double var4, double var6, World var8, boolean var9) throws CommandException {
      ...
      CommandSpreadPlayers$Position[] var19 = this.a(var10, this.a(var2), var11, var13, var15, var17);
   ...
   private int a(CommandSpreadPlayers$Position var1, double var2, World var4, Random var5, double var6, double var8, double var10, double var12, CommandSpreadPlayers$Position[] var14, boolean var15) throws CommandException {
      boolean var16 = true;
   ...
   private double a(List var1, World var2, CommandSpreadPlayers$Position[] var3, boolean var4) {
      double var5 = 0.0D;
      int var7 = 0;
   ...
   private CommandSpreadPlayers$Position[] a(Random var1, int var2, double var3, double var5, double var7, double var9) {
