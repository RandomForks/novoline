...
public class Lagometer {
   ...
   public static void showLagometer(ScaledResolution var0) {
      ...
      if(gameSettings != null && (gameSettings.ofLagometer || gameSettings.field_181657_aC)) {
         ...
         mc.fontRendererObj.drawString("30", 2.0F, (float)(var19 + 1), -8947849);
         mc.fontRendererObj.drawString("30", 1.0F, (float)var19, -3881788);
         mc.fontRendererObj.drawString("60", 2.0F, (float)(var6 + 1), -8947849);
         mc.fontRendererObj.drawString("60", 1.0F, (float)var6, -3881788);
         GlStateManager.matrixMode(5889);
         ...
         var26 = Config.limit(var26, 0.0F, 1.0F);
         ...
         mc.fontRendererObj.drawString(" " + memMbSec + " MB/s", (float)var13, (float)var14, var12);
