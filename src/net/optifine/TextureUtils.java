...
import net.optifine.TextureUtils$1;
import net.optifine.TextureUtils$2;
...
public class TextureUtils {
   ...
   public static ITextureObject getTexture(ResourceLocation var0) {
      MatchBlock.b();
      ITextureObject var2 = Config.getTextureManager().getTexture(var0);
      if(var2 != null) {
         return var2;
         ...
         Config.getTextureManager().loadTexture(var0, var3);
         return var3;
      }
   }
   ...
   public static void registerResourceListener() {
      ...
      Config.getTextureManager().loadTickableTexture(var5, var4);
   }
