...
public class azl {
   private static final float a = 1.0F / MathHelper.d(0.39269909262657166D) - 1.0F;
   private static final float b = 1.0F / MathHelper.d(0.7853981633974483D) - 1.0F;

   public BakedQuad a(Vector3f var1, Vector3f var2, BlockPartFace var3, TextureAtlasSprite var4, EnumFacing var5, ModelRotation var6, BlockPartRotation var7, boolean var8, boolean var9) {
      int[] var10 = this.a(var3, var4, var5, this.a(var1, var2), var6, var7, var8, var9);
      EnumFacing var11 = a(var10);
      this.a(var10, var11, var3.blockFaceUV, var4);
      this.a(var10, var11);
      return new BakedQuad(var10, var3.tintIndex, var11, var4);
   }

   public BakedQuad a(Vector3f var1, Vector3f var2, BlockPartFace var3, TextureAtlasSprite var4, EnumFacing var5, ITransformation var6, BlockPartRotation var7, boolean var8, boolean var9) {
      int[] var10 = this.a(var3, var4, var5, this.a(var1, var2), var6, var7, var8, var9);
      EnumFacing var11 = a(var10);
      this.a(var10, var11, var3.blockFaceUV, var4);
      this.a(var10, var11);
   ...
   private int[] a(BlockPartFace var1, TextureAtlasSprite var2, EnumFacing var3, float[] var4, ITransformation var5, BlockPartRotation var6, boolean var7, boolean var8) {
      byte var9 = 28;
      if(Config.isShaders()) {
         var9 = 56;
      }
      ...
      for(int var11 = 0; var11 < 4; ++var11) {
         this.a(var10, var11, var3, var1, var4, var2, var5, var6, var7, var8);
      }
   ...
   private int a(EnumFacing var1) {
      ...
      int var3 = MathHelper.a((int)(var2 * 255.0F), 0, 255);
      return -16777216 | var3 << 16 | var3 << 8 | var3;
   }

   private float b(EnumFacing var1) {
      switch(TG.b[var1.ordinal()]) {
      case 1:
         if(Config.isShaders()) {
   ...
   private void a(int[] var1, int var2, EnumFacing var3, BlockPartFace var4, float[] var5, TextureAtlasSprite var6, ITransformation var7, BlockPartRotation var8, boolean var9, boolean var10) {
      ...
      this.a(var1, var15, var2, var14, var12, var6, var4.blockFaceUV);
   }

   private void a(int[] var1, int var2, int var3, Vector3f var4, int var5, TextureAtlasSprite var6, BlockFaceUV var7) {
      ...
      var1[var9 + 3] = var5;
      var1[var9 + 4] = Float.floatToRawIntBits(var6.getInterpolatedU((double)var7.c(var3)));
      var1[var9 + 4 + 1] = Float.floatToRawIntBits(var6.getInterpolatedV((double)var7.b(var3)));
   }

   private void a(Vector3f var1, BlockPartRotation var2) {
      Matrix4f var3 = this.a();
      Vector3f var4 = new Vector3f(0.0F, 0.0F, 0.0F);
      switch(TG.a[var2.axis.ordinal()]) {
      case 1:
      ...
      this.a(var1, new Vector3f(var2.origin), var3, var4);
   }

   public int a(Vector3f var1, EnumFacing var2, int var3, ModelRotation var4, boolean var5) {
      return this.a(var1, var2, var3, var4, var5);
   }

   public int a(Vector3f var1, EnumFacing var2, int var3, ITransformation var4, boolean var5) {
      if(var4 == ModelRotation.X0_Y0) {
         ...
         if(Reflector.cs.d()) {
            ...
            this.a(var1, new Vector3f(0.5F, 0.5F, 0.5F), ((ModelRotation)var4).getMatrix4d(), new Vector3f(1.0F, 1.0F, 1.0F));
         }
   ...
   public void a(int[] var1, EnumFacing var2, BlockFaceUV var3, TextureAtlasSprite var4) {
   ...
   private void a(int[] var1, EnumFacing var2) {
   ...
   private void a(int var1, int[] var2, EnumFacing var3, BlockFaceUV var4, TextureAtlasSprite var5) {
