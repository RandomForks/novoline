...
// $FF: synthetic class
class GuiButtonEnumShaderOption$1 {
   static final int[] $SwitchMap$net$shadersmod$client$EnumShaderOption = new int[EnumShaderOption.values().length];
   ...
   static {
      ...
      try {
         $SwitchMap$net$shadersmod$client$EnumShaderOption[EnumShaderOption.SHADOW_CLIP_FRUSTRUM.ordinal()] = 10;
