...
public enum awD implements EntityType {
   ENTITY(-1),
   ...
   static {
      for(awD var11 : values()) {
         d.put(Integer.valueOf(var11.b), var11);
      }
