...
public class SoundRemapper {
   private static final HashMap sounds1_9 = new HashMap();
   private static final HashMap sound1_9to1_8 = new HashMap();
   private static int id;
   private static PacketRemapper[] b;

   private static void register1_9Sound(String var0) {
      sounds1_9.put(Integer.valueOf(id++), var0);
   }

   private static void registerSoundRemapping(String var0, String var1) {
      sound1_9to1_8.put(var0, var1);
   }

   public static String oldNameFromId(int var0) {
      b();
      String var2 = (String)sounds1_9.get(Integer.valueOf(var0));
      return var2 == null?null:getOldName(var2);
   }

   public static String getOldName(String var0) {
      return (String)sound1_9to1_8.getOrDefault(var0, var0);
   }
