...
public class EntityTracker extends cA implements ClientEntityIdChangeListener {
   ...
   public n5 l(int var1) {
      return (n5)this.entityOffsets.computeIfAbsent(Integer.valueOf(var1), EntityTracker::lambda$getEntityOffset$2);
   }
   ...
   public void a(int var1, n5 var2) {
   ...
   public void sendMetadataBuffer(int var1) {
      ...
      if(this.metadataBuffer.containsKey(Integer.valueOf(var1))) {
         ...
         PacketWrapperImpl var3 = new PacketWrapperImpl(28, (ByteBuf)null, this.d());
         var3.a(Type.VAR_INT, Integer.valueOf(var1));
         var3.a(Types1_8.METADATA_LIST, this.metadataBuffer.get(Integer.valueOf(var1)));
         ...
         if(!((List)this.metadataBuffer.get(Integer.valueOf(var1))).isEmpty()) {
            PacketWrapperImpl var10000 = var3;
   ...
   private static n5 lambda$setEntityOffset$4(short var0, short var1, short var2, Integer var3, n5 var4) {
      String[] var5 = d();
      if(var4 == null) {
         return new n5(var0, var1, var2);
      } else {
         var4.c(var0);
         var4.b(var1);
         var4.a(var2);
   ...
   private static n5 lambda$addToEntityOffset$3(short var0, short var1, short var2, Integer var3, n5 var4) {
      String[] var5 = d();
      if(var4 == null) {
         return new n5(var0, var1, var2);
      } else {
   ...
   private static n5 lambda$getEntityOffset$2(Integer var0) {
      return new n5(0, 0, 0);
   }
