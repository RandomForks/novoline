...
public class ItemRewriter {
   private static final Map d = com.viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter.ENTTIY_NAME_TO_ID;
   private static final Map b = com.viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter.ENTTIY_ID_TO_NAME;
   private static final Map e = com.viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter.POTION_NAME_TO_ID;
   private static final Map c = com.viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter.POTION_ID_TO_NAME;
   ...
   public static aMz a(aMz var0) {
      ...
      if(var0 == null) {
         ...
         if(var0.c() != 0 && var2.contains("Unbreakable")) {
         ...
         if(var0.e() == 383 && var0.c() == 0) {
            ...
            if(var2.contains("EntityTag")) {
               ...
               if(var18.contains("id")) {
                  ...
                  if(d.containsKey(var22.getValue())) {
                     var14 = ((Integer)d.get(var22.getValue())).intValue();
                  }
         ...
         ReplacementRegistry1_8to1_9.a(var0);
         if(var0.e() == 373 || var0.e() == 438 || var0.e() == 441) {
            int var15 = 0;
            if(var2.contains("Potion")) {
               StringTag var19 = (StringTag)var2.get("Potion");
               String var23 = var19.getValue().replace("minecraft:", "");
               if(e.containsKey(var23)) {
                  var15 = ((Integer)e.get(var23)).intValue();
               }
         ...
         if(var3.size() == 2 && ((Short)var3.get("id").getValue()).shortValue() == var0.e() && ((Short)var3.get("data").getValue()).shortValue() == var0.c()) {
            var0.d().remove("ViaRewind1_8to1_9");
            if(var0.d().isEmpty()) {
   ...
   public static aMz b(aMz var0) {
      ...
      if(var0 == null) {
         ...
         if(var0.e() == 383 && var0.c() != 0) {
            ...
            if(!var2.contains("EntityTag") && b.containsKey(Integer.valueOf(var0.c()))) {
               CompoundTag var3 = new CompoundTag("EntityTag");
               var3.put(new StringTag("id", (String)b.get(Integer.valueOf(var0.c()))));
               var2.put(var3);
            }
         ...
         if(var0.e() == 373 && (var2 == null || !var2.contains("Potion"))) {
            if(var2 == null) {
               var0.a(var2 = new CompoundTag(""));
            }
            ...
            String var6 = var0.c() == 8192?"water":com.viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter.potionNameFromDamage(var0.c());
            var2.put(new StringTag("Potion", "minecraft:" + var6));
            var0.a((short)0);
         }

         if(var2 != null && var0.d().contains("ViaRewind1_8to1_9")) {
            CompoundTag var7 = (CompoundTag)var2.remove("ViaRewind1_8to1_9");
            var0.a((int)((Short)var7.get("id").getValue()).shortValue());
            var0.a(((Short)var7.get("data").getValue()).shortValue());
   ...
   static {
      e.put("luck", Integer.valueOf(8203));
