...
import de.gerrygames.viarewind.protocol.protocol1_7_6_10to1_8.storage.Scoreboard$ScoreTeam;
...
public class Scoreboard extends cA {
   ...
   public String sendTeamForScore(String var1) {
      ...
      if(var1.length() <= 16) {
         ...
         PacketWrapperImpl var9 = new PacketWrapperImpl(62, (ByteBuf)null, this.d());
         var9.a(Type.STRING, var5);
         var9.a(Type.k, Byte.valueOf((byte)0));
         var9.a(Type.STRING, "ViaRewind");
         var9.a(Type.STRING, var6);
         var9.a(Type.STRING, var7);
         var9.a(Type.k, Byte.valueOf((byte)0));
         var9.a(Type.SHORT, Short.valueOf((short)1));
         var9.a(Type.STRING, var5);
         PacketUtil.b(var9, aRi.class, true, true);
         return var5;
      }
   }

   public String removeTeamForScore(String var1) {
      cf.b();
