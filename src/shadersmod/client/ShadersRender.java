...
public class ShadersRender {
   ...
   public static void renderShadowMap(EntityRenderer var0, int var1, float var2, long var3) {
      ...
      if(Shaders.usedShadowDepthBuffers > 0 && --Shaders.shadowPassCounter <= 0) {
         ...
         ActiveRenderInfo.updateRenderInfo(var6.thePlayer, var6.gameSettings.thirdPersonView == 2);
         ...
         var6.ab().a(TextureMap.locationBlocksTexture);
         var6.mcProfiler.endStartSection("shadow setupterrain");
         int var17 = 0;
         var17 = var0.frameCount;
         var0.frameCount = var17 + 1;
         var7.setupTerrain(var10, (double)var2, var9, var17, var6.thePlayer.isSpectator());
         var6.mcProfiler.endStartSection("shadow updatechunks");
         var6.mcProfiler.endStartSection("shadow terrain");
         GlStateManager.matrixMode(5888);
         GlStateManager.pushMatrix();
         GlStateManager.disableAlpha();
         var7.a(EnumWorldBlockLayer.SOLID, (double)var2, 2, var10);
         Shaders.checkGLError("shadow terrain solid");
         GlStateManager.enableAlpha();
         var7.a(EnumWorldBlockLayer.CUTOUT_MIPPED, (double)var2, 2, var10);
         Shaders.checkGLError("shadow terrain cutoutmipped");
         var6.ab().b(TextureMap.locationBlocksTexture).setBlurMipmap(false, false);
         var7.a(EnumWorldBlockLayer.CUTOUT, (double)var2, 2, var10);
         Shaders.checkGLError("shadow terrain cutout");
         var6.ab().b(TextureMap.locationBlocksTexture).restoreLastBlurMipmap();
         ...
         if(Shaders.isRenderShadowTranslucent()) {
            ...
            var7.a(EnumWorldBlockLayer.TRANSLUCENT, (double)var2, 2, var10);
